...
export function LogViewer({ showOnlyHighlighted }: LogViewerProps) {
    ...
    return (
        <div className="h-full bg-gray-950 font-mono text-sm flex flex-col">
            {/* Filter Status Bar */}
            {isFiltered && (
                <div className="bg-blue-900/30 border-b border-blue-700/50 px-4 py-2 flex items-center gap-2 text-sm flex-shrink-0">
